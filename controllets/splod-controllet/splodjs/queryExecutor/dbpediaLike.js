...
var dbpediaLike = function (selectedEndpoint, selectedGraph) {
	if(dbpediaLike.prototype._singletonInstance){
		return dbpediaLike.prototype._singletonInstance;
	}
...
*/
dbpediaLike.prototype.getEntitySubclasses = function(url, limit, callback) {
	var submap={};
	if(systemLang in language_classHierarchyMap){
...
*/
dbpediaLike.prototype.getConceptsFromDirectPredicate = function(predicate, limit, callback) {
	query = " prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> " +
...
*/
dbpediaLike.prototype.getConceptsFromSomething = function(predicate, limit, callback) {
	query = " prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> " +
				" prefix owl: <http://www.w3.org/2002/07/owl#> " +
				" SELECT DISTINCT ?url ?label " +
				" WHERE { ";
...
dbpediaLike.prototype.getAllReversePredicates = function(limit, callback) {
	query = " prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> " + 
		" prefix owl: <http://www.w3.org/2002/07/owl#> " +
			" SELECT DISTINCT ?url ?label " +
			" WHERE { ";
...
*/
dbpediaLike.prototype.getDirectPredicatesFromConcept = function(entity, limit, callback) {
	query = " prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> " +
				" prefix owl: <http://www.w3.org/2002/07/owl#> " +
				" SELECT DISTINCT ?url ?label " +
				" WHERE { ";
...
*/
dbpediaLike.prototype.getReversePredicatesFromConcept = function(entity, limit, callback) {
	query = " prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> " +
				" prefix owl: <http://www.w3.org/2002/07/owl#> " +
				" SELECT DISTINCT ?url ?label " +
				" WHERE { ";
...
dbpediaLike.prototype.getReversePredicatesFromPredicate = function(predicate, limit, callback) {
	query = " prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> " +
				" prefix owl: <http://www.w3.org/2002/07/owl#> " +
				" SELECT DISTINCT ?url ?label " +
				" WHERE { ";
...
dbpediaLike.prototype.getDirectPredicatesFromResult = function(url, datatype, lang, penninculo, limit, callback) {
	var result;
	switch(datatype){
		case 'uri':
		case 'img':
...
dbpediaLike.prototype.getReversePredicatesFromResult = function(url, datatype, lang, penninculo, limit, callback) {
	var result;
	switch(datatype){
		case 'uri':
		case 'img':
...
/*
	...
	WHERE { ?s dbp:name ?o }
*/
dbpediaLike.prototype.getPredicateStats = function(pred, callback){
...
*/
dbpediaLike.prototype.getConceptStats = function(concept, callback){
...
dbpediaLike.prototype.executeUserQuery = function(querySPARQL){
